#!/usr/bin/env python3
"""
SUPERSEDED AND UNSAFE -- use msgtool2.py.

The geometry below is WRONG. This tool assumes a 49-byte header and a
204-byte text field. The real layout, proven by game31.msg solving exactly as
32 + 134*253, is a 32-byte FILE header, then 253-byte records of
[17-byte record header][236-byte text field]. Importing with this tool writes
text over record headers and destroys the file.
