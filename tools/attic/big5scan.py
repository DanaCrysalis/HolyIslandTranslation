#!/usr/bin/env python3
"""
SUPERSEDED -- use big5scan2.py.

The filter here demanded that decoded runs be mostly CJK ideographs, but the
Big5 standard plane IS mostly CJK ideographs, so random 256-colour VGA data
passed at close to 100%. big5scan2.py discriminates on character FREQUENCY
instead, which actually separates prose from noise.
